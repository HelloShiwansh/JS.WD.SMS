...
// const red = hello.reduce(( acc, nums ) => acc + nums,0 );
//functionality of reduce is same as that of forEach, map and filter
//difference is that reduce returns a single value instead of an array
